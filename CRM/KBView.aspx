...
<div style="text-align:left;color:maroon; font-weight:bold; position:absolute;top:110px;right:18px;"><asp:HyperLink ID="lnkAddNew" runat="server" NavigateUrl="~/AddKB.aspx" CssClass="KBAdd" Text="Add New Knowledge Management"></asp:HyperLink></div>
