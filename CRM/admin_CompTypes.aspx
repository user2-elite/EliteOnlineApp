<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="admin_CompTypes.aspx.cs" Inherits="admin_CompTypes" %>
   ...
   <table align="center" border="1" bordercolor="#E89F65" width="85%" 
        ...
        <tr>
            <td bgcolor="#E89F65" align="center" style="height: 22px">
                ...
                Add/Edit Complaint Types</strong></span></td>
        </tr>
        <tr><td width="100%">
                        ...
                        <td align="left" colspan="2">
                           ...
                           <asp:DropDownList ID="ddlCategory" runat="server"></asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddlCategory"
                                ErrorMessage="Required" InitialValue="" ValidationGroup="Group1"></asp:RequiredFieldValidator></td>                        
                    </tr>    
                    <tr>
                        <td align="left" colspan="2">
                            Complaint Type:
                            <asp:TextBox ID="txtComplaintTypes" runat="server" MaxLength="100" Width="230px"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtComplaintTypes"
        ...
        <tr>
            <td align="left">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="True" BorderColor="Silver"
                    BorderStyle="Solid" BorderWidth="1pt" CellPadding="8" CellSpacing="0" EmptyDataText="No Complaint Types configured Yet."
