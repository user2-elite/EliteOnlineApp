<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="admin_Units.aspx.cs" Inherits="admin_Units" %>
   ...
   <table align="center" border="1" bordercolor="#E89F65" width="85%" 
        ...
        <tr>
            <td bgcolor="#E89F65" align="center" style="height: 22px">
                ...
                Add/Edit Company Units</strong></span></td>
        </tr>
        <tr><td width="100%">
   ...
   <table width="90%" align="center" cellspacing="0">
                    <tr>
                        <td align="left" colspan="2">
                            Unit Name:
                            <asp:TextBox ID="txtUnitName" runat="server" MaxLength="100" Width="230px"></asp:TextBox>
        ...
        <tr>
            <td align="left">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="True" BorderColor="Silver"
                    BorderStyle="Solid" BorderWidth="1pt" CellPadding="8" CellSpacing="0" EmptyDataText="No Units configured Yet."
