<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CRMDashboards.aspx.cs" Inherits="CRMDashboards" %>
...
<body>
    ...
    <div style="width: 100%; background-color: #EEEEEE">
        ...
        &nbsp;
        <asp:LinkButton ID="lnkComplaintsTrends" runat="server" OnClick="lnkComplaintsTrends_Click"
            CssClass="KBAdd">Trend Analysis</asp:LinkButton>
&nbsp;
        <asp:LinkButton ID="lnkPivot" runat="server" OnClick="lnkPivot_Click"
            CssClass="KBAdd">Pivot Tables</asp:LinkButton>
    </div>
    <b>
    ...
    <div id="divPeriod1" runat="server" style="background-color: #F0F0F0; width: 100%;
        ...
        <asp:RequiredFieldValidator ID="req1" ControlToValidate="ddComplaintForwardedTO"
            runat="server" InitialValue="0" ErrorMessage="Please choose Company Unit" ValidationGroup="g1"></asp:RequiredFieldValidator>
    </div>
    <div id="divPeriod2" runat="server" style="background-color: #F0F0F0; width: 100%;
        padding-top: 10px; padding-bottom: 10px;">
        <b>Year</b>:
        <asp:DropDownList ID="ddlTYear" runat="server" ValidationGroup="g2">
        </asp:DropDownList>
        &nbsp;<b> Company Unit: </b>
        <asp:DropDownList ID="ddComplaintForwardedTO2" runat="server" ValidationGroup="g2">
        </asp:DropDownList>
        &nbsp;<b> Complaint Type: </b>
        <asp:DropDownList ID="ddComplaintTypes" runat="server" ValidationGroup="g2">
        </asp:DropDownList>
        &nbsp;<asp:Button ID="btnShowReport2" runat="server" OnClick="btnShowReport_Click"
            Text="Show Report" ValidationGroup="g2" />
        <asp:RequiredFieldValidator ID="reqT1" ControlToValidate="ddComplaintForwardedTO2"
            runat="server" InitialValue="0" ErrorMessage="Please choose Company Unit" ValidationGroup="g2"></asp:RequiredFieldValidator>
        <asp:RequiredFieldValidator ID="reqT2" ControlToValidate="ddComplaintTypes" runat="server"
            InitialValue="0" ErrorMessage="Please choose Complaint Type" ValidationGroup="g2"></asp:RequiredFieldValidator>
    </div>
    <table width="100%">
        <tr>
            <td valign="top" align="left">
                <asp:Chart ID="cDashboard" runat="server" Height="450" BackColor="LightSalmon" BackSecondaryColor="AliceBlue"
                    BackGradientStyle="TopBottom" BorderColor="DarkBlue" Palette="Grayscale">
                    <Legends>
                    </Legends>
                    <Titles>
                ...
                <asp:Chart ID="cTrendChart" runat="server" Height="450" BackColor="LightSalmon" BackSecondaryColor="AliceBlue"
                    BackGradientStyle="TopBottom" BorderColor="DarkBlue" Palette="Grayscale">
                    <Legends>
                    </Legends>
                    <Titles>
                    ...
                    <Series>
                        <asp:Series Name="Series1" YValueType="Int32" IsValueShownAsLabel="true" ChartArea="MainChartArea"
                            CustomProperties="PieLineColor=BlanchedAlmond, PieDrawingStyle=SoftEdge">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea Name="MainChartArea" Area3DStyle-Enable3D="false">
                            <AxisY>
                                <LabelStyle />
                                <StripLines>
                                    <asp:StripLine TextAlignment="Near" BorderDashStyle="Solid" BorderColor="Orange"
            ...
            <td valign="top" align="left">
                <asp:Chart ID="cColChart" runat="server" Height="450" BackColor="LightSalmon" BackSecondaryColor="AliceBlue"
                    ...
                    <Series>
                        <asp:Series Name="Series1" YValueType="Int32" IsValueShownAsLabel="true" ChartArea="ChartArea1"
                            ChartType="Column" Color="Red" Legend="Legend1">
                        </asp:Series>
                        <asp:Series Name="Series2" YValueType="Int32" IsValueShownAsLabel="true" ChartArea="ChartArea1"
                            ChartType="Column" Color="Yellow" Legend="Legend2">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1" BackColor="#FFFFFF" Area3DStyle-Enable3D="true"
                    ...
                    <Legends>
                        <asp:Legend Name="Legend1" Title="Major" BackColor="Red" Docking="top">
                        </asp:Legend>
                        <asp:Legend Name="Legend2" Title="Minor" BackColor="Yellow" Docking="top">
                        </asp:Legend>
                    </Legends>
                </asp:Chart>
            </td>
            <td align="left" valign="top">
                <div id="tblChart" runat="server">
                </div>
            </td>
        </tr>
    </table>
