...
public partial class _ITDashboard : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            lnkClosedRequests.CssClass = "KBAddSelected";
        }
    }
    ...
    protected void lnkUtilization_Click(object sender, EventArgs e)
    {
        ...
        ResetColor();
        lnkUtilization.CssClass = "KBAddSelected";
    }
    ...
    private void RenderReport(string type)
    {
        try
        {
            ...
            if (type == "cl")
            {
                cDashboardsCharts.Visible = true;
                cDashboardsCharts2.Visible = false;
                ...
                cDashboardsCharts.Titles.Add("Request Status :- Below dshboard shows the lists of all active resolvers,Total requests created between the selected time period and is pending, Total requests closed between the selected time period, Total requests violated between the selected time period");
            ...
            {
                cDashboardsCharts.Visible = false;
                cDashboardsCharts2.Visible = true;
                dtObjReportDetails = BindUtilization("RPT_DashBoadUtilization", stDate, enDate);
                cDashboardsCharts2.Titles.Add("Utilization Summary :- Below dshboard shows the lists of active resolvers with total time spent (In Hours) on resolving the tickets for the selected time period. ");
                cDashboardsCharts2.Series["Series1"].XValueMember = "ResolverName";
                cDashboardsCharts2.Series["Series1"].YValueMembers = "TotalTimeSpend";
                cDashboardsCharts2.Series["Series1"].AxisLabel = "ResolverName";

                cDashboardsCharts2.Series["Series1"].SmartLabelStyle.MovingDirection = LabelAlignmentStyles.BottomLeft;
                cDashboardsCharts2.Series["Series1"].SmartLabelStyle.AllowOutsidePlotArea = LabelOutsidePlotAreaStyle.Yes;
                cDashboardsCharts2.ChartAreas[0].AxisY.LabelStyle.Font = new System.Drawing.Font("Calibiri", 12f, System.Drawing.FontStyle.Bold);
                cDashboardsCharts2.ChartAreas[0].AxisX.LabelStyle.Font = new System.Drawing.Font("Calibiri", 12f, System.Drawing.FontStyle.Bold);
                cDashboardsCharts2.ChartAreas[0].AxisY.TitleFont = new System.Drawing.Font("Calibiri", 12f, System.Drawing.FontStyle.Bold);

                //cDashboardsCharts2.Titles.LabelStyle.Font = new System.Drawing.Font("Calibiri", 12f, System.Drawing.FontStyle.Bold);
                cDashboardsCharts2.ChartAreas[0].AxisY.LabelStyle.ForeColor = System.Drawing.Color.Black;
                cDashboardsCharts2.ChartAreas[0].AxisX.LabelStyle.Angle = 90;
                cDashboardsCharts2.ChartAreas[0].AxisX.LabelStyle.Interval = 1;
                cDashboardsCharts2.DataSource = dtObjReportDetails;
                cDashboardsCharts2.DataBind();
                cDashboardsCharts2.Series["Series1"].Color = System.Drawing.Color.LightGreen;
            }
    ...
    {
       lnkClosedRequests.CssClass = "KBAdd";
       lnkUtilization.CssClass = "KBAdd";
    }
}