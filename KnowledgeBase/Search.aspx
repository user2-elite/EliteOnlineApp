                        ...
                        <p>
                            ...
                            <div class="pure-form pure-form-stacked">
                                <div class="pure-g">
                                    ...
                                    <div class="pure-u-1 pure-u-md-1-3">
                                    Search In
                                    <asp:DropDownList ID="ddlSearchType2" runat="server" Width="190px">
                                        <asp:ListItem Text="Key Word" Value="K"></asp:ListItem>
                                        <asp:ListItem Text="Content" Value="C"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            ...
                            <div class="pure-form pure-form-stacked">
                                <div class="pure-g">
                                    <br />
                                     <div class="pure-u-1 pure-u-md-1-3">
                                    Search In
                                    <asp:DropDownList ID="ddlSearchType3" runat="server" Width="190px">
                                        <asp:ListItem Text="Key Word" Value="K"></asp:ListItem>
                                        <asp:ListItem Text="Content" Value="C"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
