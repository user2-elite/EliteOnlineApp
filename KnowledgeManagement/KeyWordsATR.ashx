<%@ WebHandler Language="C#" Class="KeyWordsATR" %>
...
using System.Text;
using System.Data;
public class KeyWordsATR : IHttpHandler {
    ...
    public void ProcessRequest(HttpContext context)
    {
         ...
         * */
        //-------------------- =Cache Checking ---------------------------------
        if (context.Cache["KeyWordsATR"] != null)
        {
            dt = (DataTable)context.Cache["KeyWordsATR"];
        }
        else
        {
            using (SqlConnection conn = new SqlConnection())
            {
                ...
                {
                    //CRM_KB_GetATRKeyWords
                //CRM_KB_GetBestPracticeKeyWords
                    ...
                    using (SqlDataAdapter sda = new SqlDataAdapter(cmd))
                    {
                        ...
                        context.Cache.Insert("KeyWordsATR", dt, sqlDep);
                    }
                    //dt.Dispose();
                    conn.Close();
                }
