<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LeavePage.aspx.cs" Inherits="LeavePage" %>
    ...
    <form id="form1" runat="server">
        <div class="container" id="pnlEmpty" runat="server">
            <div class="panel panel-default">
                <h3>Manager details not updated in system. To proceed leave request, please contact your HR/IT support team to update manager information.</h3>
        </div></div>
                ...
                <div class="panel-body">
                    ...
                    <div role="tabpanel">
                        <ul id="myTab" class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a href="#ViewPrint" aria-controls="profile" role="tab" data-toggle="tab">Leave History </a></li>
                        </ul>
                    </div>
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="Create">
                            <asp:Label ID="Label3" runat="server" Text="Leave Quota" ForeColor="#000066" Font-Bold="True" Font-Underline="True"></asp:Label>
                            ...
                            <asp:GridView ID="GridView2" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover"
                                ...
                                <Columns>
                                    <asp:BoundField DataField="AbsenseQuotaText" HeaderText="Time Account" ReadOnly="True" SortExpression="AbsenseQuotaText" />
                                    <asp:BoundField DataField="DedFrom" HeaderText="Deduction From" SortExpression="DedFrom" />
                                    <asp:BoundField DataField="DedTo" HeaderText="Deduction To" SortExpression="DedTo" />
                                    <asp:BoundField DataField="Number" HeaderText="Entitlement" SortExpression="Number"  />
                                    <asp:BoundField DataField="Deduction" HeaderText="Deduction" SortExpression="Deduction"  />
                                    <asp:BoundField DataField="Balance" HeaderText="Entitlement minus Deduction" SortExpression="Balance" />                                   
                                </Columns>
                            </asp:GridView>
                            </div>
                            <hr />
                                     <asp:Label ID="lblMessageHeader" runat="server" Text=" "></asp:Label>
                                        <br />
                            <asp:Label ID="Label2" runat="server" Text="Leave Details" ForeColor="#000066" Font-Bold="True" Font-Underline="True"></asp:Label>
                            <div class="row" style="margin-top:10px;">
                                <div class="col-sm-4 col-md-4">
                                    <label for="userid">Type of Leave </label>
                                </div>
                                <div class="col-sm-6 col-md-6">
                                    <asp:DropDownList ID="DropDownList1" runat="server" class="form-control" AppendDataBoundItems="true"
                                        DataTextField="AbsenseQuotaText" DataValueField="AbsenseQuotaType">
                        ...
                        <div role="tabpanel" class="tab-pane" id="ViewPrint" style="max-height:500px; overflow:auto;">
                            <asp:Label ID="Label1" runat="server" Text="Leave Request" ForeColor="#000066" Font-Bold="True" Font-Underline="True"></asp:Label>
                            ...
                            <asp:GridView ID="GridView1" runat="server" Width="100%" CssClass="table table-striped table-bordered table-hover"
                                ...
                                EmptyDataText="There are no data records to display.">
                                <Columns>
                                    <asp:BoundField DataField="AbsenseText" HeaderText="AbsenseText" ReadOnly="True" SortExpression="AbsenseQuotaText" />
