<%@ Page Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="ViewOnBoardingCompleted.aspx.cs" Inherits="ViewOnBoardingCompleted" Title="Employee Onboarding - Completed" %>
    ...
    <div style="left: 10px; top: 3px; margin-left: 10px;">
        ...
        <div class="pure-form pure-form-stacked" style="width: 100%; margin: 0px; padding: 0px;
            ...
            <table width="100%" bgcolor="#E89F65" cellpadding="3" cellspacing="3">
                <tr>
                    <td>
                           <asp:DataGrid ID="grid1" runat="server" AutoGenerateColumns="True" Width="1200px" BackColor="White" BorderColor="#F0F0F0" BorderStyle="Outset" BorderWidth="1px" 
                           CellPadding="10" CellSpacing="10" GridLines="Both">
