...
public partial class AddBandName : System.Web.UI.Page
{
    ...
    private void ListData()
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("ListBand", conn);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (strValue.Length > 1)
            {
                ...
                {
                    cmdSave = new SqlCommand("UpdateBand", connSave);
                ...
                {
                    cmdSave = new SqlCommand("CreateBand", connSave);
                    cmdSave.CommandType = CommandType.StoredProcedure;
                    cmdSave.Parameters.AddWithValue("@Name", strValue);
    ...
    protected void grid1_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "cmDelete")
        {
            try
            {
                ...
                connSave.Open();
                cmdDelete = new SqlCommand("DeleteBand", connSave);
