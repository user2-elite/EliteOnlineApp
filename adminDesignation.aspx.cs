...
public partial class AddDesignationName : System.Web.UI.Page
{
    ...
    private void ListData()
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("ListDesignation", conn);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (strValue.Length > 1)
            {
                ...
                {
                    cmdSave = new SqlCommand("UpdateDesignation", connSave);
                ...
                {
                    cmdSave = new SqlCommand("CreateDesignation", connSave);
                    cmdSave.CommandType = CommandType.StoredProcedure;
                    cmdSave.Parameters.AddWithValue("@Name", strValue);
    ...
    protected void grid1_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        if (e.CommandName == "cmEdit")
        {
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection())
                {
                    ...
                    {
                        cmd.CommandText = "GetDesignationByID";
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        else if (e.CommandName == "cmDelete")
        {
            try
            {
                ...
                connSave.Open();
                cmdDelete = new SqlCommand("DeleteDesignation", connSave);
