...
public partial class AddLocationName : System.Web.UI.Page
{
    ...
    private void ListData()
    {
        try
        {
            ...
            SqlCommand cmd = new SqlCommand("ListLocation", conn);
        ...
        {
            ShowMessage(diverror, "Error", "Error while displaying data!"+ ex);
        }
    }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (strValue.Length > 1)
            {
                ...
                {
                    cmdSave = new SqlCommand("UpdateLocation", connSave);
                ...
                {
                    cmdSave = new SqlCommand("CreateLocation", connSave);
                    cmdSave.CommandType = CommandType.StoredProcedure;
                    cmdSave.Parameters.AddWithValue("@Name", strValue);
    ...
    protected void grid1_ItemCommand(object source, DataGridCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "cmDelete")
        {
            try
            {
                ...
                connSave.Open();
                cmdDelete = new SqlCommand("DeleteLocation", connSave);
