<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="adminNews.aspx.cs" Inherits="adminNews" ValidateRequest="false" Trace="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h3>
        News & Events - Add New</h3>
    <p>
        Update News & Events here.</p>
    <div>
        <div class="pure-form pure-form-stacked" style="width: 100%; margin: 0px; padding: 10px;
            ...
            <div class="pure-g">
                ...
                <div class="pure-u-1 pure-u-md-1-1">
                    News/Event Title (Maximum 50 Characters)<br />
                ...
                <div class="pure-u-1 pure-u-md-1-1">
                    (Image size should be with in 100 KB. maximum width: 350, Maximum Height: 250)
                    <br />
                    Upload Image
                    <br />
        ...
        <asp:Panel runat="server" ID="pnlList">
            ...
            <div class="pure-u-1">
                <asp:DataGrid ID="grid1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    <Columns>
                        <asp:BoundColumn DataField="News_Title" HeaderText="Title"></asp:BoundColumn>
                        <asp:BoundColumn DataField="News_Text" HeaderText="Content"></asp:BoundColumn>
