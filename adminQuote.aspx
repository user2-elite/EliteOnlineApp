<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true"
    CodeFile="adminQuote.aspx.cs" Inherits="AddQuote" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <h3>Quote For the Day - Add New</h3>
                        ...
                        <div class="pure-form pure-form-stacked" style="background-color: #EEEEEE; border: 1px;
                            ...
                            <div class="pure-g">
                                ...
                                <div class="pure-u-1 pure-u-md-1-3">
                                    Quote Text (Max length:500, Min Length: 25)<br />
                                    <asp:TextBox ID="txtQuote" runat="server" Width="650px" MaxLength="500"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txtQuote"
                                ...
                                <div class="pure-u-1 pure-u-md-1-1">
                                    ...
                                    <asp:Button ID="btnSubmit" runat="server" Text="Save Quote" class="btn btn-success"
                    ...
                    <asp:Panel runat="server" ID="pnlList">
                        ...
                        <div class="pure-u-1">
                            <asp:DataGrid ID="grid1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <Columns>
                                    <asp:BoundColumn DataField="QuoteText" HeaderText="Quote Text"></asp:BoundColumn>
